...
All notable changes to the "Curriculum Vitae" will be documented in this file.
...
- Added "Certifications and Certified Courses" section
- Rephrasing on multiple entries
- Added secret switch to enable/disable the display of the full CV URL
- Added version number to the CV page
- Modified download button dimensions

## [1.5.0] - 2026-08-10

### Added

- Added CILab Internship experience
- Added secret toggle to enable/disable removal of table entries
- Added labels to secret switches
- Removed secret removable divs menu
- Code Refactoring
- Bug Fixes
...
- Better items lists display and formatting.
...
- First Released Curriculum version.
...
[unreleased]: https://github.com/filippochinni/Curriculum-Vitae/compare/v1.5.0...HEAD
[1.5.0]: https://github.com/filippochinni/Curriculum-Vitae/compare/v1.4.0...v1.5.0
...
[0.1.0]: https://github.com/filippochinni/Curriculum-Vitae/releases/tag/v0.1.0
